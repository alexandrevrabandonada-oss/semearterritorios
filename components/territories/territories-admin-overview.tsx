    ...
    <section className="mt-6 rounded-[2rem] border border-white/80 bg-white p-5 shadow-soft">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-stone-600">
            A lista oficial tem 56 bairros no CSV conferido. Após aplicar as migrations, setor, região e código oficial ficam em campos estruturados para relatórios e futuro mapa interno.
          </p>
        </div>
      </div>
